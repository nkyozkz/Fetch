...
//variable para poder usar mis productos en el archivo json
let productosJSON = [];
...
$(document).ready(function () {
  ...
  //evento al boton finalizar compra para que el usuario confirme su compra
    ...
    Swal.fire({
        ...
        text: `Total de la compra: $${calcularTotalCarrito()}`,
...
function agregarAlCarrito(productoAgregado) {
    ...
    //agregamos una nueva fila a la tabla de carrito si el producto no estaba
